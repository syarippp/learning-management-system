<!--**********************************
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; SMKN 10 Malang</p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
    ...
    <script src="<?= base_url() ?>main/assets/plugins/raphael/raphael.min.js"></script>
    <script src="<?= base_url() ?>main/assets/plugins/morris/morris.min.js"></script>
