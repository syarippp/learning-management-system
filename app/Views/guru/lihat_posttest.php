                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="basic-form">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="pertanyaan1" class="form-control" placeholder="Pertanyaan Soal 1" value="" required>
                                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="basic-form">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="jawaban_1a" class="form-control" placeholder="Jawaban A" value="Belum tau cara nampilin gg" required>
                                                </div>
                                                <div class="form-group">
                                                    <label class="text-label">Jawaban B</label>
                                                    <input type="text" name="jawaban_1b" class="form-control" placeholder="Jawaban B" value="Belum tau cara nampilin gg" required>
                                                </div>
                                                <div class="form-group">
                                                    <label class="text-label">Jawaban C</label>
                                                    <input type="text" name="jawaban_1c" class="form-control" placeholder="Jawaban C" value="Belum tau cara nampilin gg" required>
                                                </div>
                                                <div class="form-group">
                                                    <label class="text-label">Jawaban D</label>
                                                    <input type="text" name="jawaban_1d" class="form-control" placeholder="Jawaban D" value="Belum tau cara nampilin gg" required>
                                                </div>
